...
function startChartStream() {
    // PATCH: Disable WebSocket connection, always use REST polling for chart data
    stopChartStream();
    chartStreamKey = null;
    updateStreamStatusBadge('reconnect', 'Polling');
    // No-op: chart will be updated by REST polling only
}
